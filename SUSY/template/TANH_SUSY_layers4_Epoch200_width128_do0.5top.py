...
benchmark = str(sys.argv[1])  # raw, highlevel or all
...
# .iloc[:, a:b] means all datas in the 1st dimension and the datas which index is 'a to b-1' of in the 2nd dimension
...
log_dir = home + '\\logs\\SUSY\\TANH_model_SUSY_layers{}_Epoch{}_width{}_do{}top_{}'
log_dir = log_dir.format(layers, EPOCH, width, dropout, benchmark)
filename = home + '\\saves\\SUSY\\TANH_model_SUSY_layers{}_Epoch{}_width{}_do{}top_{}.h5'
